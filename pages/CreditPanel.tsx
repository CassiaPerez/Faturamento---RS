             ...
             <div className="p-5 flex-1 space-y-4">
                           ...
                           {sol.itens_solicitados.map((item, idx) => (
                               <li key={idx} className="flex justify-between items-start text-xs text-slate-700 bg-slate-50/50 p-2 rounded border border-slate-100">
                                   ...
                                   <div className="flex flex-col items-end">
                                      <span className="font-bold text-indigo-600">{item.volume.toLocaleString('pt-BR', {minimumFractionDigits: 2, maximumFractionDigits: 2})} {item.unidade}</span>
                                   </div>
                               </li>
                           ))}
                       </ul>
               ...
               <div className="flex justify-between items-end">
                   <div>
                       ...
                       <p className="text-xl font-bold text-slate-800">{sol.volume_solicitado.toLocaleString('pt-BR', {minimumFractionDigits: 2, maximumFractionDigits: 2})}</p>
                   </div>
